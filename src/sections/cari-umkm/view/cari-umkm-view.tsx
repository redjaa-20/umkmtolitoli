          ...
          <div className="md:col-span-3 space-y-7 md:space-y-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-y-7">
              {paginatedUmkm.map((item, index) => {
                ...
                const itemKategori = item.category
                  .toLowerCase()
                  .replace(/\s+/g, "-");
                const hrefUrl = `/umkm/${itemKecamatan}/${itemDesa}/${itemKategori}/${item.slug}`;

                return (
                  <Link key={index} href={hrefUrl} className="group">
